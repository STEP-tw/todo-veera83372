...
TodoApp.prototype= {
  ...
  deleteListItem:function(user,listId,itemId){
    this.todos[user].deleteItem(listId,itemId);
    this.saveTodos();
  },
  ...
  updateItem:function(user,listId,itemId,title){
    this.todos[user].updateItemTitle(listId,itemId,title);
    this.saveTodos();
  },
  updateItemStatus:function(user,listId,itemId,title){
    this.todos[user].updateItemStatus(listId,itemId);
    this.saveTodos();
  }
};
